...
var Timer = module.exports = function(mins, options) {
  ...
  this.landing = options.landing || Landing;
};
...
Timer.prototype.initial = function() {
  if (this.landing.progress)
    this.landing.progress(0, '-', this.color);
};

Timer.prototype.update = function() {
  if (this.landing.progress)
    this.landing.progress(this.percent(), this.elapsedMsg(), this.color);
};

Timer.prototype.done = function() {
  if (this.landing.done)
    this.landing.done();
};
